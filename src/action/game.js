...
gameSpace.Match.prototype.startMatch = function() 
{
	...
	Fort1 = new objects.Fortress("#8B4513",true, "square", [15,floorObj.top-50,50,50],0);
	Fort2 = new objects.Fortress("#8B4513",true, "square", [width-15-50,floorObj.top-50,50,50],1);
	//var floorObj = new objects.Floor("#00FF00",true, "square", [0,height-70,width,70]);
